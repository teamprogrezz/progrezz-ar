...
/* Objecto toroide */
ARProgrezz.Object.Torus = function (coords, collectable, onSelectEvent, arControls, anisotropy, range) {
    ...
    this.updateAnimation = function (delta) {
        ...
        scope.threeObject.rotation.y += ROTATION * delta; // Rotación Y
        scope.threeObject.rotation.z += ROTATION * delta; // Rotación Z
    };
    ...
    function init() {
        ...
        // Creando objeto de Three.js
        var material = new THREE.MeshBasicMaterial({map: texture});
        var geometry = new THREE.TorusGeometry(OBJECT_RADIUS, OBJECT_RADIUS / 4.0);
...
/* Objecto toroide */
ARProgrezz.Object.Cylinder = function (coords, collectable, onSelectEvent, arControls, anisotropy, range) {
    ...
    function init() {
        ...
        // Creando objeto de Three.js
        var material = new THREE.MeshBasicMaterial({map: texture});
        var geometry = new THREE.CylinderGeometry( 1, OBJECT_RADIUS, OBJECT_RADIUS * 3);
